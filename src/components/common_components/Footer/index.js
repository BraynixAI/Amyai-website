        ...
        <div class="mx-auto max-w-screen-xl px- pb-6 pt-16 sm:px-6 lg:px-8">
          ...
          <div class="flex md:flex-row md:justify-between flex-col-reverse gap-4 border-t border-gray-500">
            <div class=" bg-gray-900 ">
              <div class="mt-10 grid grid-cols-3 md:gap-8 gap-4 dark:border-gray-800">
                <div class="">
                  <p class="md:text-lg text-xs font-medium text-gray-900 dark:text-white uppercase">
                    Our Company
                  </p>
                  ...
                  <ul class="mt-8 space-y-4 md:text-sm text-xs">
                    ...
                    <li>
                      <a
                        ...
                        href="/"
                      >
                        Data Science Analist
                      </a>
                    </li>
                  </ul>
                </div>
                <div class="">
                  <p class="md:text-lg text-xs font-medium text-gray-900 uppercase dark:text-white">
                    Contact info
                  </p>
            ...
            <div className="flex justify-end">
              <div class="bg-gray-900 md:mt-10 ">
