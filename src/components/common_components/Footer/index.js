    ...
    <div>
      <footer class="bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-5 gap-4 border-t border-gray-100">
            <div class="col-span-3 bg-gray-900 ">
              <div class="mt-16 grid grid-cols-1 gap-8  dark:border-gray-800 md:grid-cols-3 lg:grid-cols-3">
            ...
            <div class="col-span-2 bg-gray-900 md:mt-16 self">
